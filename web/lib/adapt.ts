 ...
 *      fixtures/fleet_status.json says {sandboxes_active, hypotheses_completed,
 ...
 *      fixtures/field_collapsed.json says {location, t_s, radius_m, tolerance_s,
 *      description}. Both accepted.
 *
 * (case_loaded no longer drifts: fixtures/case.json is now the §8 extraction
 ...
 *  metadata fixtures/case.json wraps around it. */
