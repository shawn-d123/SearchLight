"""
Generate the two payloads CONTRACT.md specifies but fixtures/ does not yet carry.
...
(case.json, extraction.json and transcript.txt now ship in ../fixtures/ and are
...
case = json.loads((REPO / "fixtures" / "case.json").read_text())
...
sim_started = {
    ...
    "_note": (
        "Generated by web/scripts/make-web-fixtures.py from the committed "
