...
Reads : pipeline/mapscore/case_in/input_unsorted.csv          (distributable subset)
        pipeline/mapscore/case_in/exported_case_Library.txt   (ISRID ids, terrain)
...
def load_cases():
    ...
    if not src.exists():
        sys.exit("FATAL: " + str(src) + " not found. Run: git clone "
                 "https://github.com/ctwardy/mapscore pipeline/mapscore")
...
def main():
    ...
    rule("CASE DIRECTORIES IN pipeline/mapscore")
