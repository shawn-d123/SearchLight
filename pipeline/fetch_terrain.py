...
can be run the moment the OpenTopography key arrives:
    ...
    python pipeline/fetch_terrain.py osm          # trails + water, no key needed
    python pipeline/fetch_terrain.py elevation    # needs OPENTOPO_API_KEY
    python pipeline/fetch_terrain.py arrays       # builds whatever inputs exist
    python pipeline/fetch_terrain.py all
...
def stage_elevation(bbox):
    ...
    if not key:
        ...
        print("  then:  python pipeline/fetch_terrain.py elevation")
        return False
